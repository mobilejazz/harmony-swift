    ...
    public func set(_ viewController: UIViewController, animation: Animation = .none) {
        if isViewLoaded {
            ...
            case .newModalBottom:
                ...
                newVC.view.frame = view.bounds.offsetBy(dx: 0, dy: UIScreen.main.bounds.size.height)
                view.insertSubview(newVC.view, aboveSubview: oldVC.view)
                UIView.animate(withDuration: ContainerViewController.animationDuration,
                               delay: 0,
                               options: ContainerViewController.animationOptions,
                               animations: {
            ...
            case .oldModalBottom:
                let frame = view.bounds.offsetBy(dx: 0, dy: UIScreen.main.bounds.size.height)
                view.insertSubview(newVC.view, belowSubview: oldVC.view)
                UIView.animate(withDuration: ContainerViewController.animationDuration,
                               delay: 0,
                               options: ContainerViewController.animationOptions,
