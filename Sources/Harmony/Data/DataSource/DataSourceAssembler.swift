...
///
public final class DataSourceAssembler<
    Get: GetDataSource,
    Put: PutDataSource,
...
public extension DataSourceAssembler where Get == Put, Get == Delete {
...
public extension DataSourceAssembler where Put == VoidPutDataSource<T>, Delete == VoidDeleteDataSource {
    /// Initializer for a single DataSource
    ///
...
public extension DataSourceAssembler where Get == VoidGetDataSource<T>, Delete == VoidDeleteDataSource {
    /// Initializer for a single DataSource
    ///
...
public extension DataSourceAssembler where Get == VoidGetDataSource<T>, Put == VoidPutDataSource<T> {
    /// Initializer for a single DataSource
    ///
...
public extension DataSourceAssembler where Get == VoidGetDataSource<T> {
    /// Initializer for a single DataSource
    ///
    /// - Parameter putDataSource: The data source
    /// - Parameter deleteDataSource: The data source
...
public extension DataSourceAssembler where Put == VoidPutDataSource<T> {
    /// Initializer for a single DataSource
    ///
    /// - Parameter getDataSource: The data source
    /// - Parameter deleteDataSource: The data source
...
public extension DataSourceAssembler where Delete == VoidDeleteDataSource {
    /// Initializer for a single DataSource
    ///
    /// - Parameter getDataSource: The data source
    /// - Parameter putDataSource: The data source
